...
echo ==============================================================================
echo  🎨 Sweet Hanzi Auto Shorts: 원클릭 스마트 시작 및 환경 자동 진단
echo ==============================================================================
echo.
...
if not exist "assets\svg_drawings\車_drawing.svg" (
    echo [주의] 160개 상형문자 직관적 이미지 에셋이 아직 동기화되지 않았습니다.
    set NEED_SETUP=1
)
